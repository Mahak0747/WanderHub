...
.post(isLoggedIn,validateListing,upload.single("listing[image][url]"),wrapAsyc(listingController.createListing))
...
.put(isLoggedIn,isOwner,validateListing,wrapAsyc(listingController.updateListing))
